...
public class HomeMiracleDView extends FrameLayout {

    private TextView tvPairD;
    private TextView tvDescription;
    private TextView tvDetial;

    public HomeMiracleDView(Context context) {
        super(context);
        initInflate();
        intitInstance();
    }

    public HomeMiracleDView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        intitInstance();
    }

    public HomeMiracleDView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public HomeMiracleDView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.layout_miracle_home_d, this);
    }
