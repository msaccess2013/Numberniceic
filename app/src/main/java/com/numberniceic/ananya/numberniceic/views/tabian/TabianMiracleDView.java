...
public class TabianMiracleDView extends FrameLayout {

    private TextView tvPairD;
    private TextView tvDescription;
    private TextView tvDetial;

    public TabianMiracleDView(Context context) {
        super(context);
        initInflate();
        intitInstance();
    }

    public TabianMiracleDView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initInflate();
        intitInstance();
    }

    public TabianMiracleDView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public TabianMiracleDView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initInflate() {
        inflate(getContext(), R.layout.layout_miracle_tabian_d, this);
    }
